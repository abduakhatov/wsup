...
def avg_circles(circles, b):
    ...
    avg_r=0
    for i in range(b):
        #optional - average for multiple circles (can happen when a
        # gauge is at a slight angle)
...
def calibrate_gauge(gauge_number, file_type):
    ...
    #detect circles
    #restricting the search from 35-48% of the possible radii gives fairly good results
